  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="bg-zinc-950 border border-zinc-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl shadow-black/80 relative text-zinc-100">
        ...
        <div className="space-y-2.5 text-xs font-mono bg-zinc-900/70 p-4 rounded-xl border border-zinc-800">
          ...
          {folder && (
            <>
              <div className="flex justify-between py-1 border-b border-zinc-800/80">
                ...
                <span className="text-orange-400 font-bold">{folder.folder_uid}</span>
              </div>
              <div className="flex justify-between py-1 border-b border-zinc-800/80">
        ...
        {file && (
          <div className="mt-4 flex items-center justify-between gap-2 p-2.5 bg-black/80 rounded-lg border border-zinc-800 text-xs">
            <span className="font-mono text-zinc-300 truncate max-w-[280px]">{file.raw_url}</span>
            <div className="flex items-center gap-1.5 shrink-0">
              <button
                onClick={handleCopy}
                className="px-2.5 py-1 rounded bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 active:scale-95 text-zinc-200 font-sans font-medium flex items-center gap-1 transition-all"
              >
              ...
              <a
                ...
                className="p-1 rounded bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 active:scale-95 text-zinc-300 transition-all"
              >
