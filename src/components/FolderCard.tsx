...
export const FolderCard: React.FC<FolderCardProps> = ({
  ...
  return (
    <div
      ...
      className="group bg-zinc-900/80 hover:bg-zinc-900 border border-zinc-800 hover:border-orange-500/50 rounded-xl p-4 cursor-pointer transition-all shadow-sm hover:shadow-orange-950/20 flex items-center justify-between gap-3 select-none"
    >
      <div className="flex items-center gap-3 min-w-0">
        <div className="w-10 h-10 rounded-xl bg-orange-600/15 border border-orange-500/30 flex items-center justify-center text-orange-400 group-hover:scale-105 transition-transform shrink-0">
      ...
      <div className="relative shrink-0" ref={menuRef} onClick={(e) => e.stopPropagation()}>
        ...
        {menuOpen && (
          <div className="absolute right-0 top-full mt-1 w-40 bg-zinc-950 border border-zinc-800 rounded-lg shadow-xl z-20 py-1 text-xs">
            <button
